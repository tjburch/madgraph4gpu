...
void ixxxxx(const fptype *allmomenta, const fptype &fmass, const int &nhel,
            const int &nsf, cxtype fi[6],
            ...
            sycl::nd_item<3> item_ct1) // input: particle# out of npar
{
  ...
  if (fmass != 0.0)
  {
    ...
    else
    {
      ...
      {
        chi[1] = cxtype(nh * p[1], p[2]) / sycl::sqrt(2.0 * pp * pp3);
      }
...
void imzxxx(const fptype *allmomenta, const int &nhel, const int &nsf,
            cxtype fi[6],
#ifndef SYCL_LANGUAGE_VERSION
            const int ievt,
#endif
...
void ixzxxx(const fptype *allmomenta, const int &nhel, const int &nsf,
            cxtype fi[6],
#ifndef SYCL_LANGUAGE_VERSION
            const int ievt,
#endif
...
void vxxxxx(const fptype *allmomenta, const fptype &vmass, const int &nhel,
            const int &nsv, cxtype vc[6],
#ifndef SYCL_LANGUAGE_VERSION
            const int ievt,
#endif
            const int ipar,
...
void sxxxxx(const fptype *allmomenta, const fptype &smass, const int &nhel,
            const int &nss, cxtype sc[3],
#ifndef SYCL_LANGUAGE_VERSION
            const int ievt,
#endif
            const int ipar, sycl::nd_item<3> item_ct1)
{
#ifdef SYCL_LANGUAGE_VERSION
  const int ievt = item_ct1.get_local_range().get(2) * item_ct1.get_group(2) +
                   item_ct1.get_local_id(2); // index of event (thread) in grid
...
void oxxxxx(const fptype *allmomenta, const fptype &fmass, const int &nhel,
            const int &nsf, cxtype fo[6],
#ifndef SYCL_LANGUAGE_VERSION
            const int ievt,
#endif
            const int ipar,
...
void opzxxx(const fptype *allmomenta, const int &nhel, const int &nsf,
            cxtype fo[6],
#ifndef SYCL_LANGUAGE_VERSION
            const int ievt,
#endif
...
void omzxxx(const fptype *allmomenta, const int &nhel, const int &nsf,
            cxtype fo[6],
#ifndef SYCL_LANGUAGE_VERSION
            const int ievt,
#endif
...
void oxzxxx(const fptype *allmomenta, const int &nhel, const int &nsf,
            cxtype fo[6],
#ifndef SYCL_LANGUAGE_VERSION
            const int ievt,
#endif
